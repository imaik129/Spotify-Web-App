...
var i = 0;
var txt = 'Music is life itself. \n Louis Armstrong';
var speed = 50;


document.addEventListener('DOMContentLoaded',function(event){
  // array with texts to type in typewriter
  var dataText = [ "Music.", "is.", "life.", "itself.", "Louis Armstrong", "Music is life itself. - Louis Armstrong ", "With Spotify", "people don't get it", "until they try it.", "With Spotify, people don't get it until they try it. Then they tell their friends. - Daniel Ek", "Where words fail, music speaks"];

  // allTexts.push(dataText);
  // allTexts.posh(dataText);
  ...
  function typeWriter(text, i, fnCallback) {
    ...
    if (i < (text.length)) {
     ...
     document.getElementById("page_quote").innerHTML = text.substring(0, i+1) +'<span aria-hidden="true"></span>';
  ...
  // start a typewriter animation for a text in the dataText array
   function StartTextAnimation(i, c) {
